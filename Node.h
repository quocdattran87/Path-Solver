...
public:
    ...
    /*                                           */
    bool isSameNodeAs(Node* toCompare);
    bool isUpperNodeOf(Node* toCompare);
    bool isRightNodeOf(Node* toCompare);
    bool isLeftNodeOf(Node* toCompare);
    bool isLowerNodeOf(Node* toCompare);
    bool isOneDistanceLessOf(Node* toCompare);
