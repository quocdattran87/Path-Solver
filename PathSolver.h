...
public:
    ...
    /*                                           */
    Node* findStartOrEnd(Env env, char symbol);
    void findMoveableNeighbourBlock(Env env, Node* nextMove, NodeList* openList);
    bool isNotInList(NodeList* nodes, int row, int col);
